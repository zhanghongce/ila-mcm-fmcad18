...
ProcInst = [SendResetDevice, WriteSMImage ] #ProcInst = [SendResetDevice, WriteSMImage, SendLoadFw, ReceiveReportSts ]
ProcState= ['DriPC']
...
ReceiveLoadFw = Instruction('ReceiveLoadFw', lambda state: state('SMImageAddr') == GOOD_IMAGE ) # state('LoadFWAddress') == ACTION_WRITE)
...
"""
DevInst = [ReceiveReset, ReceiveLoadFw]
